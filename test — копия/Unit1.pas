...
form1.image2.Top:=0;
form1.image2.left:=0;
form1.image2.width:=screen.Width;
form1.image2.height:=screen.Height;
form1.image47.Top:=screen.height div 3+screen.height div 3;
form1.Image47.width:=screen.width div 4;
l:=form1.Image47.width;
form1.Image47.width:=screen.width div 2+l;
form1.Image47.Left:=screen.width div 7;
form1.Image3.Height:=screen.height div 9 ;
form1.Image3.width:=screen.width div 13 ;
form1.Image4.Height:=screen.height div 9 ;
form1.Image4.width:=screen.width div 13;
form1.Image5.Height:=screen.height div 9 ;
form1.Image5.width:=screen.width div 13;
form1.Image6.Height:=screen.height div 9 ;
form1.Image6.width:=screen.width div 13;
form1.Image7.Height:=screen.height div 9 ;
form1.Image7.width:=screen.width div 13;
form1.Image8.Height:=screen.height div 9 ;
form1.Image8.width:=screen.width div 13;
form1.Image9.Height:=screen.height div 9 ;
form1.Image9.width:=screen.width div 13;
form1.Image10.Height:=screen.height div 9 ;
form1.Image10.width:=screen.width div 13;
form1.Image11.Height:=screen.height div 9 ;
form1.Image11.width:=screen.width div 13;
form1.Image12.Height:=screen.height div 9 ;
form1.Image12.width:=screen.width div 13;
form1.Image13.Height:=screen.height div 9 ;
form1.Image13.width:=screen.width div 13;
form1.Image14.Height:=screen.height div 9 ;
form1.Image14.width:=screen.width div 13;
form1.Image15.Height:=screen.height div 9 ;
form1.Image15.width:=screen.width div 13;
form1.Image16.Height:=screen.height div 9 ;
form1.Image16.width:=screen.width div 13;
form1.Image17.Height:=screen.height div 9 ;
form1.Image17.width:=screen.width div 13;
form1.Image18.Height:=screen.height div 9 ;
form1.Image18.width:=screen.width div 13;
form1.Image19.Height:=screen.height div 9 ;
form1.Image19.width:=screen.width div 13;
form1.Image20.Height:=screen.height div 9 ;
form1.Image20.width:=screen.width div 13;
form1.Image21.Height:=screen.height div 9 ;
form1.Image21.width:=screen.width div 13;
form1.Image22.Height:=screen.height div 9 ;
form1.Image22.width:=screen.width div 13;
form1.Image23.Height:=screen.height div 9 ;
form1.Image23.width:=screen.width div 13;
form1.Image24.Height:=screen.height div 9 ;
form1.Image24.width:=screen.width div 13;
form1.Image25.Height:=screen.height div 9 ;
form1.Image25.width:=screen.width div 13;
form1.Image26.Height:=screen.height div 9 ;
form1.Image26.width:=screen.width div 13;
form1.Image27.Height:=screen.height div 9 ;
form1.Image27.width:=screen.width div 13;
form1.Image28.Height:=screen.height div 9 ;
form1.Image28.width:=screen.width div 13;
form1.Image29.Height:=screen.height div 9 ;
form1.Image29.width:=screen.width div 13;
form1.Image30.Height:=screen.height div 9 ;
form1.Image30.width:=screen.width div 13;
form1.Image31.Height:=screen.height div 9 ;
form1.Image31.width:=screen.width div 13;
form1.Image32.Height:=screen.height div 9 ;
form1.Image32.width:=screen.width div 13;
form1.Image33.Height:=screen.height div 9 ;
form1.Image33.width:=screen.width div 13 ;
form1.Image34.Height:=screen.height div 9 ;
form1.Image34.width:=screen.width div 13 ;
form1.Image35.Height:=screen.height div 9 ;
form1.Image35.width:=screen.width div 13 ;
form1.Image37.Height:=screen.height div 9 ;
form1.Image37.width:=screen.width div 13 ;
form1.Image38.Height:=screen.height div 9 ;
form1.Image38.width:=screen.width div 13 ;
form1.Image39.Height:=screen.height div 9 ;
form1.Image39.width:=screen.width div 13 ;
form1.Image40.Height:=screen.height div 9 ;
form1.Image40.width:=screen.width div 13 ;
form1.Image41.Height:=screen.height div 9 ;
form1.Image41.width:=screen.width div 13 ;
form1.Image42.Height:=screen.height div 9 ;
form1.Image42.width:=screen.width div 13 ;
form1.Image43.Height:=screen.height div 9 ;
form1.Image43.width:=screen.width div 13 ;
form1.Image44.Height:=screen.height div 9 ;
form1.Image44.width:=screen.width div 13 ;
form1.Image45.Height:=screen.height div 9 ;
form1.Image45.width:=screen.width div 13 ;
form1.Image46.Height:=screen.height div 9 ;
form1.Image46.width:=screen.width div 13 ;
...
procedure TForm1.Image36MouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
...
procedure TForm1.Image37MouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
...
procedure TForm1.Image38MouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
form1.Timer3.Enabled:=true;
move:=false
...
procedure TForm1.Image39MouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
form1.Timer3.Enabled:=true;
move:=false
...
procedure TForm1.Image40MouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
form1.Timer3.Enabled:=true;
move:=false
...
procedure TForm1.Image41MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
if move then begin
...
procedure TForm1.Image41MouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
form1.Timer3.Enabled:=true;
move:=false
...
procedure TForm1.Image42MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
if move then begin
...
procedure TForm1.Image42MouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
form1.Timer3.Enabled:=true;
move:=false
...
procedure TForm1.Image43MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
if move then begin
...
procedure TForm1.Image43MouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
form1.Timer3.Enabled:=true;
move:=false
...
procedure TForm1.Image44MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
if move then begin
...
procedure TForm1.Image45MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
if move then begin
...
procedure TForm1.Image45MouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
form1.Timer3.Enabled:=true;
move:=false
...
procedure TForm1.Image46MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
if move then begin
...
begin
if (form1.image37.top<=form1.image47.top) and (form1.image37.top+form1.image37.Height>=form1.image47.top)
then begin form1.image37.top:=form1.image47.top-form1.image37.Height;
    if form1.image37.left mod form1.image37.Width<form1.image37.Width div 2 then
    form1.image37.left:=form1.image37.left-form1.image37.left mod form1.image37.Width else
    form1.image37.left:=form1.image37.left+form1.image37.Width-form1.image37.left mod form1.image37.Width;
end;
if form1.image37.left=form1.image38.left then form1.image38.left:=form1.image38.left+form1.image38.width;
if form1.image37.left=form1.image39.left then form1.image39.left:=form1.image39.left+form1.image39.width;
if form1.image37.left=form1.image40.left then form1.image40.left:=form1.image40.left+form1.image40.width;
if form1.image37.left=form1.image41.left then form1.image41.left:=form1.image41.left+form1.image41.width;
if form1.image37.left=form1.image42.left then form1.image42.left:=form1.image42.left+form1.image42.width;
if form1.image37.left=form1.image43.left then form1.image43.left:=form1.image43.left+form1.image43.width;
if form1.image37.left=form1.image44.left then form1.image44.left:=form1.image44.left+form1.image44.width;
if form1.image37.left=form1.image45.left then form1.image45.left:=form1.image45.left+form1.image45.width;
if form1.image37.left=form1.image46.left then form1.image46.left:=form1.image46.left+form1.image46.width;

if (form1.image38.top<=form1.image47.top) and (form1.image38.top+form1.image38.Height>=form1.image47.top)
then begin form1.image38.top:=form1.image47.top-form1.image38.Height;
    if form1.image38.left mod form1.image38.Width<form1.image38.Width div 2 then
    form1.image38.left:=form1.image38.left-form1.image38.left mod form1.image38.Width else
    form1.image38.left:=form1.image38.left+form1.image38.Width-form1.image38.left mod form1.image38.Width;
end;
if form1.image38.left=form1.image37.left then form1.image37.left:=form1.image37.left+form1.image37.width;
if form1.image38.left=form1.image39.left then form1.image39.left:=form1.image39.left+form1.image39.width;
if form1.image38.left=form1.image40.left then form1.image40.left:=form1.image40.left+form1.image40.width;
if form1.image38.left=form1.image41.left then form1.image41.left:=form1.image41.left+form1.image41.width;
if form1.image38.left=form1.image42.left then form1.image42.left:=form1.image42.left+form1.image42.width;
if form1.image38.left=form1.image43.left then form1.image43.left:=form1.image43.left+form1.image43.width;
if form1.image38.left=form1.image44.left then form1.image44.left:=form1.image44.left+form1.image44.width;
if form1.image38.left=form1.image45.left then form1.image45.left:=form1.image45.left+form1.image45.width;
if form1.image38.left=form1.image46.left then form1.image46.left:=form1.image46.left+form1.image46.width;

if (form1.image39.top<=form1.image47.top) and (form1.image39.top+form1.image37.Height>=form1.image47.top)
then begin form1.image39.top:=form1.image47.top-form1.image39.Height;
if form1.image39.left mod form1.image39.Width<form1.image39.Width div 2 then
    form1.image39.left:=form1.image39.left-form1.image39.left mod form1.image39.Width else
    form1.image39.left:=form1.image39.left+form1.image39.Width-form1.image39.left mod form1.image39.Width;
end;
if form1.image39.left=form1.image38.left then form1.image38.left:=form1.image38.left+form1.image38.width;
if form1.image39.left=form1.image37.left then form1.image37.left:=form1.image37.left+form1.image37.width;
if form1.image39.left=form1.image40.left then form1.image40.left:=form1.image40.left+form1.image40.width;
if form1.image39.left=form1.image41.left then form1.image41.left:=form1.image41.left+form1.image41.width;
if form1.image39.left=form1.image42.left then form1.image42.left:=form1.image42.left+form1.image42.width;
if form1.image39.left=form1.image43.left then form1.image43.left:=form1.image43.left+form1.image43.width;
if form1.image39.left=form1.image44.left then form1.image44.left:=form1.image44.left+form1.image44.width;
if form1.image39.left=form1.image45.left then form1.image45.left:=form1.image45.left+form1.image45.width;
if form1.image39.left=form1.image46.left then form1.image46.left:=form1.image46.left+form1.image46.width;

if (form1.image40.top<=form1.image47.top) and (form1.image40.top+form1.image40.Height>=form1.image47.top)
then begin form1.image40.top:=form1.image47.top-form1.image40.Height;
if form1.image40.left mod form1.image40.Width<form1.image40.Width div 2 then
    form1.image40.left:=form1.image40.left-form1.image40.left mod form1.image40.Width else
    form1.image40.left:=form1.image40.left+form1.image40.Width-form1.image40.left mod form1.image40.Width;
end;
if form1.image40.left=form1.image38.left then form1.image38.left:=form1.image38.left+form1.image38.width;
if form1.image40.left=form1.image39.left then form1.image39.left:=form1.image39.left+form1.image39.width;
if form1.image40.left=form1.image37.left then form1.image37.left:=form1.image37.left+form1.image37.width;
if form1.image40.left=form1.image41.left then form1.image41.left:=form1.image41.left+form1.image41.width;
if form1.image40.left=form1.image42.left then form1.image42.left:=form1.image42.left+form1.image42.width;
if form1.image40.left=form1.image43.left then form1.image43.left:=form1.image43.left+form1.image43.width;
if form1.image40.left=form1.image44.left then form1.image44.left:=form1.image44.left+form1.image44.width;
if form1.image40.left=form1.image45.left then form1.image45.left:=form1.image45.left+form1.image45.width;
if form1.image40.left=form1.image46.left then form1.image46.left:=form1.image46.left+form1.image46.width;

if (form1.image41.top<=form1.image47.top) and (form1.image41.top+form1.image41.Height>=form1.image47.top)
then begin form1.image41.top:=form1.image47.top-form1.image41.Height;
  if form1.image41.left mod form1.image41.Width<form1.image41.Width div 2 then
    form1.image41.left:=form1.image41.left-form1.image41.left mod form1.image41.Width else
    form1.image41.left:=form1.image41.left+form1.image41.Width-form1.image41.left mod form1.image41.Width;
end;
if form1.image41.left=form1.image38.left then form1.image38.left:=form1.image38.left+form1.image38.width;
if form1.image41.left=form1.image39.left then form1.image39.left:=form1.image39.left+form1.image39.width;
if form1.image41.left=form1.image40.left then form1.image40.left:=form1.image40.left+form1.image40.width;
if form1.image41.left=form1.image37.left then form1.image37.left:=form1.image37.left+form1.image37.width;
if form1.image41.left=form1.image42.left then form1.image42.left:=form1.image42.left+form1.image42.width;
if form1.image41.left=form1.image43.left then form1.image43.left:=form1.image43.left+form1.image43.width;
if form1.image41.left=form1.image44.left then form1.image44.left:=form1.image44.left+form1.image44.width;
if form1.image41.left=form1.image45.left then form1.image45.left:=form1.image45.left+form1.image45.width;
if form1.image41.left=form1.image46.left then form1.image46.left:=form1.image46.left+form1.image46.width;


if (form1.image42.top<=form1.image47.top) and (form1.image42.top+form1.image42.Height>=form1.image47.top)
then begin form1.image42.top:=form1.image47.top-form1.image42.Height;
 if form1.image42.left mod form1.image42.Width<form1.image38.Width div 2 then
    form1.image42.left:=form1.image42.left-form1.image42.left mod form1.image42.Width else
    form1.image42.left:=form1.image42.left+form1.image42.Width-form1.image42.left mod form1.image42.Width;
end;
if form1.image42.left=form1.image38.left then form1.image38.left:=form1.image38.left+form1.image38.width;
if form1.image42.left=form1.image39.left then form1.image39.left:=form1.image39.left+form1.image39.width;
if form1.image42.left=form1.image40.left then form1.image40.left:=form1.image40.left+form1.image40.width;
if form1.image42.left=form1.image41.left then form1.image41.left:=form1.image41.left+form1.image41.width;
if form1.image42.left=form1.image37.left then form1.image37.left:=form1.image37.left+form1.image37.width;
if form1.image42.left=form1.image43.left then form1.image43.left:=form1.image43.left+form1.image43.width;
if form1.image42.left=form1.image44.left then form1.image44.left:=form1.image44.left+form1.image44.width;
if form1.image42.left=form1.image45.left then form1.image45.left:=form1.image45.left+form1.image45.width;
if form1.image42.left=form1.image46.left then form1.image46.left:=form1.image46.left+form1.image46.width;

if (form1.image43.top<=form1.image47.top) and (form1.image43.top+form1.image43.Height>=form1.image47.top)
then begin form1.image43.top:=form1.image47.top-form1.image43.Height;
if form1.image43.left mod form1.image43.Width<form1.image43.Width div 2 then
    form1.image43.left:=form1.image43.left-form1.image43.left mod form1.image43.Width else
    form1.image43.left:=form1.image43.left+form1.image43.Width-form1.image43.left mod form1.image43.Width;
end;
if form1.image43.left=form1.image38.left then form1.image38.left:=form1.image38.left+form1.image38.width;
if form1.image43.left=form1.image39.left then form1.image39.left:=form1.image39.left+form1.image39.width;
if form1.image43.left=form1.image40.left then form1.image40.left:=form1.image40.left+form1.image40.width;
if form1.image43.left=form1.image41.left then form1.image41.left:=form1.image41.left+form1.image41.width;
if form1.image43.left=form1.image42.left then form1.image42.left:=form1.image42.left+form1.image42.width;
if form1.image43.left=form1.image37.left then form1.image37.left:=form1.image37.left+form1.image37.width;
if form1.image43.left=form1.image44.left then form1.image44.left:=form1.image44.left+form1.image44.width;
if form1.image43.left=form1.image45.left then form1.image45.left:=form1.image45.left+form1.image45.width;
if form1.image43.left=form1.image46.left then form1.image46.left:=form1.image46.left+form1.image46.width;

if (form1.image44.top<=form1.image47.top) and (form1.image44.top+form1.image44.Height>=form1.image47.top)
then begin form1.image44.top:=form1.image47.top-form1.image44.Height;
    if form1.image44.left mod form1.image44.Width<form1.image44.Width div 2 then
    form1.image44.left:=form1.image44.left-form1.image44.left mod form1.image44.Width else
    form1.image44.left:=form1.image44.left+form1.image44.Width-form1.image44.left mod form1.image44.Width;
end;
if form1.image44.left=form1.image38.left then form1.image38.left:=form1.image38.left+form1.image38.width;
if form1.image44.left=form1.image39.left then form1.image39.left:=form1.image39.left+form1.image39.width;
if form1.image44.left=form1.image40.left then form1.image40.left:=form1.image40.left+form1.image40.width;
if form1.image44.left=form1.image41.left then form1.image41.left:=form1.image41.left+form1.image41.width;
if form1.image44.left=form1.image42.left then form1.image42.left:=form1.image42.left+form1.image42.width;
if form1.image44.left=form1.image43.left then form1.image43.left:=form1.image43.left+form1.image43.width;
if form1.image44.left=form1.image37.left then form1.image37.left:=form1.image37.left+form1.image37.width;
if form1.image44.left=form1.image45.left then form1.image45.left:=form1.image45.left+form1.image45.width;
if form1.image44.left=form1.image46.left then form1.image46.left:=form1.image46.left+form1.image46.width;

if (form1.image45.top<=form1.image47.top) and (form1.image45.top+form1.image45.Height>=form1.image47.top)
then begin form1.image45.top:=form1.image47.top-form1.image45.Height;
     if form1.image45.left mod form1.image45.Width<form1.image45.Width div 2 then
    form1.image45.left:=form1.image45.left-form1.image45.left mod form1.image45.Width else
    form1.image45.left:=form1.image45.left+form1.image45.Width-form1.image45.left mod form1.image45.Width;
end;
if form1.image45.left=form1.image38.left then form1.image38.left:=form1.image38.left+form1.image38.width;
if form1.image45.left=form1.image39.left then form1.image39.left:=form1.image39.left+form1.image39.width;
if form1.image45.left=form1.image40.left then form1.image40.left:=form1.image40.left+form1.image40.width;
if form1.image45.left=form1.image41.left then form1.image41.left:=form1.image41.left+form1.image41.width;
if form1.image45.left=form1.image42.left then form1.image42.left:=form1.image42.left+form1.image42.width;
if form1.image45.left=form1.image43.left then form1.image43.left:=form1.image43.left+form1.image43.width;
if form1.image45.left=form1.image44.left then form1.image44.left:=form1.image44.left+form1.image44.width;
if form1.image45.left=form1.image37.left then form1.image37.left:=form1.image37.left+form1.image37.width;
if form1.image45.left=form1.image46.left then form1.image46.left:=form1.image46.left+form1.image46.width;

if (form1.image46.top<=form1.image47.top) and (form1.image46.top+form1.image46.Height>=form1.image47.top)
then begin form1.image46.top:=form1.image47.top-form1.image4.Height;
      if form1.image46.left mod form1.image46.Width<form1.image46.Width div 2 then
    form1.image46.left:=form1.image46.left-form1.image46.left mod form1.image46.Width else
    form1.image46.left:=form1.image46.left+form1.image46.Width-form1.image46.left mod form1.image46.Width;
end;
if form1.image46.left=form1.image38.left then form1.image38.left:=form1.image38.left+form1.image38.width;
if form1.image46.left=form1.image39.left then form1.image39.left:=form1.image39.left+form1.image39.width;
if form1.image46.left=form1.image40.left then form1.image40.left:=form1.image40.left+form1.image40.width;
if form1.image46.left=form1.image41.left then form1.image41.left:=form1.image41.left+form1.image41.width;
if form1.image46.left=form1.image42.left then form1.image42.left:=form1.image42.left+form1.image42.width;
if form1.image46.left=form1.image44.left then form1.image44.left:=form1.image44.left+form1.image44.width;
if form1.image46.left=form1.image44.left then form1.image44.left:=form1.image44.left+form1.image44.width;
if form1.image46.left=form1.image45.left then form1.image45.left:=form1.image45.left+form1.image45.width;
if form1.image46.left=form1.image37.left then form1.image37.left:=form1.image37.left+form1.image37.width;
d:=screen.Width;
   if form1.image37.left<d then d:=form1.image37.left;
   if form1.image38.left<d then d:=form1.image38.left;
   if form1.image39.left<d then d:=form1.image39.left;
   if form1.image40.left<d then d:=form1.image40.left;
   if form1.image41.left<d then d:=form1.image41.left;
   if form1.image42.left<d then d:=form1.image42.left;
   if form1.image43.left<d then d:=form1.image43.left;
   if form1.image44.left<d then d:=form1.image44.left;
   if form1.image45.left<d then d:=form1.image45.left;
   if form1.image46.left<d then d:=form1.image46.left;
st3:='';
for i:=1 to length(st1) do begin
if d=form1.image37.left then st3:=st3+st2[1];
if d=form1.image38.left then st3:=st3+st2[2];
if d=form1.image39.left then st3:=st3+st2[3];
if d=form1.image40.left then st3:=st3+st2[4];
if d=form1.image41.left then st3:=st3+st2[5];
if d=form1.image42.left then st3:=st3+st2[6];
if d=form1.image43.left then st3:=st3+st2[7];
if d=form1.image44.left then st3:=st3+st2[8];
if d=form1.image45.left then st3:=st3+st2[9];
if d=form1.image46.left then st3:=st3+st2[10];
d:=d+form1.image46.Width;
 end;
...
u:=2;
st1:='';
form1.Label2.left:=(screen.Width+form1.Label2.Width) div 2-form1.Label2.Width;
form1.Label2.top:=(screen.Height  div 2) -(form1.Label2.height*2);
 label2.Visible:=true;     
...
begin
GetCursorPos(pt);
  form1.image1.left:=pt.X-x1;
  form1.image1.top:=pt.y-y1;
end;
